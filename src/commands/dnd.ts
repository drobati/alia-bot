...
async function handleCreateGame(interaction: ChatInputCommandInteraction, context: Context) {
    ...
    try {
        ...
        const introMessage = {
            role: 'user' as const,
            content: 'Begin the adventure with an engaging introduction to this world. '
                + 'Set the scene for the players. IMPORTANT: Keep your response under 1500 characters total.',
        };
